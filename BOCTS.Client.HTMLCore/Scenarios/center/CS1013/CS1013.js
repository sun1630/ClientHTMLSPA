        ...
        return {
            ...
            activities: {
                ...
                'showAccount': wfjs.Activity({
                    ...
                    $inputs: {
                        Page: '"Scenarios/center/CS1013/CS1012_1"',
                        ShowType: '"model"',
                ...
                'showName': wfjs.Activity({
                    activity: new showScreen(),
                    $inputs: {
                        Page: '"Scenarios/center/CS1013/CS1012_2"',
                        ShowType: '"model"',//normal model
                ...
                'showResult': wfjs.Activity({
                    activity: new showScreen(),
                    $inputs: {
                        Page: '"Scenarios/center/CS1013/CS1012_3"',
                        ShowType: '"model"',
                ...
                'Showfourth': wfjs.Activity({
                    activity: new showScreen(),
                    $inputs: {
                        Page: '"Scenarios/center/CS1013/CS1012_4"',
                        ShowType: '"model"',
                        ShowData: 'this.showData'
                    },
                    next: 'null'
