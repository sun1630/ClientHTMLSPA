define(['jsRuntime/parManager', 'jsRuntime/resourceManager', 'jsRuntime/actionManager',
    ...
    function (pm, rm, am, popupSelect, maskInputs, wm, utility) {
        var m = function (cx) {
            ...
            this.accountuse = ko.observable().extend({ required: true });
            ...
            this.compositionComplete = function () {
                ...
                self.selectProvince.init('mainView');
            ...
            this.method1 = function () {
                ...
                //var para = { "runningWf": "stack", transTitle: "测试出栈" };
                //wm.global.startFlow("CS1012", para);
            };
            ...
            this.butA = function () {
                ...
                self.am.showDialog('Shells/wfAsk', null,self.instanceid).then(function () { });
            ...
            this.butB = function () {
                self.am.showMessage('ButB', '请确认',
                        [{ text: "确认", value: "Yes" }, { text: "取消", value: "No" }, { text: "忽略", value: 'ignore' }], false, self.instanceid).
                       then(function (data) { });
            };
